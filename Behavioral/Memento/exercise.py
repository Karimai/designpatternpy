...
class TokenMachine:
    ...
    def add_token(self, token):
        ...
        shallow_cpy = Memento(self.tokens[:])
...
class Evaluate(TestCase):
    def test_single_token(self):
        ...
        self.assertEqual(
            123, tm.tokens[0].value, msg="The first token's value should be 123"
        )
    ...
    def test_two_tokens(self):
        ...
        self.assertEqual(
            2, tm.tokens[1].value, msg="Second token should have the value 2"
        )
