...
Imagine a game where one or more rats can attack a player. Each individual rat has an initial
attack value of 1. However, rats attack as a swarm, so each rat's attack value is actually
...
class Rat:
    def __init__(self, game: Game):
        self.game = game
        self.attack: int = 1
        # register your observer functions
    ...
    def rat_dies(self, which_rat: Rat):
        self.attack -= 1
